...
function updateCertificate() {
    ...
    newCertificateDiv.innerHTML = `
        <span class="rsCerti">${certificateName},</span><br>
        <span class="rsCYear">${issuedDate}</span>
...
var mobpvopen = document.querySelector('.mobPreviewopen');
var rsPreview = document.querySelector('.rspreview');

mobpvopen.addEventListener('click', function () {
    rsPreview.style.display='block'
    mobpvopen.style.display='none'

})
function rsprclose(){
    rsPreview.style.display='none'
    mobpvopen.style.display='block'
}
